	...
	if (idev != -1 && ndev == 0) {
		...
		if (ndev && ndev < 9) {
			...
			if (d3) {
				...
				flag_set |= (qd + idev)->clean[ndev - 1] = (strstr(d3, "clean")
						!= NULL );
				if (!flag_set)
					printf(
...
static PARSELIST pl[] = {
		{ "DEVICE", (PVFV) ParseDevs, offsetof(QMDATA, qdev) }, { "ROMIM",
				(PVFV) ParseList, offsetof(QMDATA, romlist), (uxt) ParseROM }, {
				"PRINT", (PVFV) pString, offsetof(QMDATA, prtcmd), 63 }, {
				"SER1", (PVFV) pString, offsetof(QMDATA, ser1), 63 }, { "SER2",
				(PVFV) pString, offsetof(QMDATA, ser2), 63 }, { "SER3",
				(PVFV) pString, offsetof(QMDATA, ser2), 63 }, { "SER4",
				(PVFV) pString, offsetof(QMDATA, ser2), 63 }, { "ROMDIR",
				(PVFV) pString, offsetof(QMDATA, romdir), 127 }, { "SYSROM",
				(PVFV) pString, offsetof(QMDATA, sysrom), 63 }, { "RAMTOP",
				(PVFV) pInt4, offsetof(QMDATA, ramtop) }, { "CPU_HOG",
				(PVFV) pInt2, offsetof(QMDATA, cpu_hog) }, { "FAST_START",
				(PVFV) pInt2, offsetof(QMDATA, fastStartup) }, { "SKIP_BOOT",
				(PVFV) pInt2, offsetof(QMDATA, skip_boot) }, { "STRICT_LOCK",
				(PVFV) pInt2, offsetof(QMDATA, strict_lock) }, { "NO_PATCH",
				(PVFV) pInt2, offsetof(QMDATA, no_patch) }, { NULL, NULL }, };
