...
/* TRA table structure, from PiQ:
   ...
   liste1 0006 zeichen.00 Code f�r CHR$(0)
     0007 zeichen.01 Code f�r CHR$(1)
   ... bis CHR$(255)
   ...
   auf Viererposten mit Null aufgef�llt.
     0005 zeichen.x1 n�chste zu ersetzende Nummer,
   wie oben
   ... etc. ...
				...
				if (c == ReadByte(tab2data + 4 * i)) {
					*pd++ = ReadByte(tab2data + 4 * i + 1);
					if (ReadByte(tab2data + 4 * i + 2)) {
						*pd++ = ReadByte(tab2data +
								 4 * i + 2);
						if (ReadByte(tab2data + 4 * i +
							     3))
							*pd++ = ReadByte(
								tab2data +
								4 * i + 3);
...
static struct {
	...
	int ql;
		  ...
		  { 161, 179 }, { 162, 157 }, { 163, 96 },  { 164, 183 },
		  { 165, 158 }, { 167, 182 }, { 169, 127 }, { 171, 184 },
		  { 176, 186 }, { 180, 159 }, { 181, 176 }, { 187, 185 },
		  { 191, 180 },

		  { 197, 162 }, { 196, 160 }, { 195, 161 }, { 198, 170 },
		  { 199, 168 }, { 201, 163 }, { 214, 164 }, { 213, 165 },
		  { 216, 166 }, { 220, 167 }, { 223, 156 }, { 224, 141 },
		  { 233, 131 }, { 227, 129 }, { 228, 128 }, { 229, 130 },
		  { 230, 138 }, { 231, 136 }, { 232, 144 }, { 234, 145 },
		  { 236, 148 }, { 237, 147 }, { 238, 149 }, { 239, 146 },
		  { 240, 173 }, { 241, 137 }, { 242, 151 }, { 243, 150 },
		  { 244, 152 }, { 246, 132 }, { 247, 187 }, { 248, 134 },
		  { 249, 154 }, { 250, 153 }, { 251, 155 }, { 252, 135 },
