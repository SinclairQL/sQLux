...
if [ "x$PI_HOST" != "x" ]; then
	...
	ssh $PI_HOST "cd tmp-build;cmake -B armv6/ -DCMAKE_BUILD_TYPE=Release ; cmake --build armv6/"
...
if [ "x$ARM64_HOST" != "x" ]; then
	...
	ssh $ARM64_HOST "cd tmp-build;cmake -B arm64/ -DCMAKE_BUILD_TYPE=Release ; cmake --build arm64/"
...
if [ "x$ARMV7_HOST" != "x" ]; then
	...
	ssh $ARMV7_HOST "cd tmp-build;cmake -B armv7/ -DCMAKE_BUILD_TYPE=Release ; cmake --build armv7/"
